...
class QNAP_Import_Database {
    ...
    public static function execute( $params, QNAP_Database $mysql = null ) {
        ...
        // Set progress
        $message = sprintf( __( 'Restoring database...', QNAP_PLUGIN_NAME ));
        $params = QNAP_Progress_Bar::update($params, $query_offset, $total_queries_size, $message);
        ...
        if ( $mysql->import( qnap_database_path( $params ), $query_offset ) ) {
            ...
            // Set progress
            $message = __( 'Done restoring database.', QNAP_PLUGIN_NAME );
            $params = QNAP_Progress_Bar::update($params, 100, 100, $message);
