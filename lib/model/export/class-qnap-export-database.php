...
class QNAP_Export_Database {
    ...
    public static function execute( $params ) {
        ...
        // Set progress
        $message = sprintf( __( 'Exporting database...', QNAP_PLUGIN_NAME ), $table_rows );
        $params = QNAP_Progress_Bar::update($params, $table_index, $total_tables_count, $message);
        ...
        if ( $mysql->export( qnap_database_path( $params ), $query_offset, $table_index, $table_offset, $table_rows, $table_rows_count ) ) {
            ...
            // Set progress
            $message = __( 'Done exporting database.', QNAP_PLUGIN_NAME );
            $params = QNAP_Progress_Bar::update($params, $total_tables_count, $total_tables_count, $message);
            ...
            // Set progress
            $message = sprintf( __( 'Exporting database...', QNAP_PLUGIN_NAME ));
            $params = QNAP_Progress_Bar::update($params, $table_index, $total_tables_count, $message);
