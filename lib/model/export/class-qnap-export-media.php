...
class QNAP_Export_Media {
    ...
    public static function execute( $params ) {
        ...
        // Set progress
        $message = sprintf( __( 'Archiving %d media files...', QNAP_PLUGIN_NAME ), $total_media_files_count);
        $params = QNAP_Progress_Bar::update($params, $processed_files_size, $total_media_files_size, $message);
        ...
        if ( feof( $media_list ) ) {
            ...
            // Set progress to 100%
            $message = sprintf( __( 'Finished archiving %d media files.', QNAP_PLUGIN_NAME ), $total_media_files_count);
            $params = QNAP_Progress_Bar::update($params, $total_media_files_size, $total_media_files_size, $message);
